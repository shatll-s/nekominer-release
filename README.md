...
**Installation URL:**
```
https://github.com/shatll-s/nekominer-release/releases/download/v0.9.2/nekominer-hiveos-0.9.2.tar.gz
```
...
```json
{
  ...
  "items": [{
    ...
    "miner_config": {
      ...
      "install_url": "https://github.com/shatll-s/nekominer-release/releases/download/v0.9.2/nekominer-hiveos-0.9.2.tar.gz",
...
**Installation URL:**
```
https://github.com/shatll-s/nekominer-release/releases/download/v0.9.2/nekominer-osdog-0.9.2.tar.gz
```
...
```json
{
  ...
  "addition": "-a blake3",
  "fork": "latest",
  "custom_url": "https://github.com/shatll-s/nekominer-release/releases/download/v0.9.2/nekominer-osdog-0.9.2.tar.gz"
}
```
</details>
