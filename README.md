...
**Installation URL:**
```
https://github.com/shatll-s/nekominer-release/releases/download/v0.9.10/nekominer-hiveos-0.9.10.tar.gz
```
...
```json
{
  ...
  "items": [{
    ...
    "miner_config": {
      ...
      "install_url": "https://github.com/shatll-s/nekominer-release/releases/download/v0.9.10/nekominer-hiveos-0.9.10.tar.gz",
...
**Installation URL:**
```
https://github.com/shatll-s/nekominer-release/releases/download/v0.9.10/nekominer-osdog-0.9.10.tar.gz
```
...
```json
{
  ...
  "addition": "-a blake3",
  "fork": "latest",
  "custom_url": "https://github.com/shatll-s/nekominer-release/releases/download/v0.9.10/nekominer-osdog-0.9.10.tar.gz"
}
```
</details>
